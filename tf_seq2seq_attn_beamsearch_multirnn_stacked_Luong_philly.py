...
with graph.as_default():
	...
	################################################### ends initialization 
	#set up encoder 
    forward_cell = tf.contrib.rnn.MultiRNNCell([tf.nn.rnn_cell.BasicLSTMCell(num_nodes) for _ in range(num_layers)])
    backward_cell = tf.contrib.rnn.MultiRNNCell([tf.nn.rnn_cell.BasicLSTMCell(num_nodes) for _ in range(num_layers)])
